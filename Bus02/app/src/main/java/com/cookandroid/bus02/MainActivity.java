...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String serviceUrl = "http://ws.bus.go.kr/api/rest/buspos/getBusPosByRtid"; // 노선ID 추출을 위한 공공DB PAI 의 URL
        ...
        String busRouteId = "232000047"; //노선버스의 노선번호
        String strUrl = serviceUrl+"?ServiceKey="+serviceKey+"&busRouteId="+busRouteId; //공공 DB API호출을 위한 URL
